...
{capture name=path}{l s='Payment by Efecty' mod='efecty'}{/capture}
...
<h3>{l s='Payment by Efecty' mod='efecty'}</h3>
<form action="{$this_path_ssl}validation.php" method="post">
<p>
	<img src="{$this_path}efecty.jpg" alt="{l s='bank wire' mod='efecty'}" width="86" height="49" style="float:left; margin: 0px 10px 5px 0px;" />
...
<p class="cart_navigation">
	<a href="{$link->getPageLink('order.php', true)}?step=3" class="button_large hideOnSubmit">{l s='Other payment methods' mod='efecty'}</a>
	<input type="submit" name="submit" value="{l s='I confirm my order' mod='efecty'}" class="exclusive_large hideOnSubmit" />
</p>
</form>
{/if}
